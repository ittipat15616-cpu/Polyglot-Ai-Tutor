...
const DATA_FILE_PATH = path.join(__dirname, '../../../../../../../antigravity/Polyglot-AI-Tutor-New/src/data/listening_lessons.json');
const VOA_FILE_PATH = path.join(__dirname, '../../../../../../../antigravity/Polyglot-AI-Tutor-New/src/data/voa_lessons.json');
