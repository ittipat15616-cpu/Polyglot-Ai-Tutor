...
images_dir = os.path.join(base_dir, 'public', 'Courseware_Images', 'grammar_beginner')
...
def extract_all_pages():
    ...
    for pdf_path in pdf_files:
        ...
        # e.g., Courseware_Images/grammar_beginner/04_Verb_to_Be/4_1
        out_dir = os.path.join(images_dir, parent_dir, subtopic_id)
        os.makedirs(out_dir, exist_ok=True)
        
        manifest_key = f"Courseware_Images/grammar_beginner/{parent_dir}/{subtopic_id}"
    ...
    print("Page extraction and manifest update complete!")
