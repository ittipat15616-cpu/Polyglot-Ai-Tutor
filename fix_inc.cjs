...
async function main() {
    ...
    // limit to 80 per run to fit within 60 seconds easily
    toFix = toFix.slice(0, 80);

    const batchSize = 80;
    
    // Do all in background so node script will just finish on timeout, BUT WE CAN SAVE INCREMENTALLY!
                    ...
                    responseSchema: {
                        ...
                        items: {
                            ...
                            properties: {
                                ...
                                new_example_th: { type: Type.STRING, description: "Must only contain Thai characters, NO English letters." }
                            },
